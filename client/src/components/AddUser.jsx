...
import { useAddUserItemMutation } from '../features/user/UserApiSlice';
...
const AddUser = () => {
  ...
  const [adduserFunc, { isError, error, isSuccess, data }] =useAddUserItemMutation()
